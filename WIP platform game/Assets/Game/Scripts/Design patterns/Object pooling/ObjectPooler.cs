...
public class ObjectPoolItem
{
	...
	public ObjectPoolItem(string name ,GameObject obj, int amt, bool exp = true)
	{
		this.name = name;
		objectToPool = obj;
...
public class ObjectPooler : MonoBehaviour
{
	...
	public GameObject GetPooledObject(string name ,int index)
	{
	...
	public int AddObject(string name,GameObject GO, int amt = 3, bool exp = true)
	{
		ObjectPoolItem item = new ObjectPoolItem(name ,GO, amt, exp);
